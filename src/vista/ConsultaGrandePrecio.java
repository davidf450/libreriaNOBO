 ...
 */
public class ConsultaGrandePrecio extends javax.swing.JDialog {
    Producto prod = new Producto();
    ControladorProducto ctrpro = new ControladorProducto();
    /**
     * Creates new form consultaPrecio
     */
    public ConsultaGrandePrecio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        String codigo = JOptionPane.showInputDialog("Escanee el producto por favor");
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaGrandePrecio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaGrandePrecio dialog = new ConsultaGrandePrecio(new javax.swing.JFrame(), true);
